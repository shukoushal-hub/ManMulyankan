...
app.get('/test/:name', (req, res) => {
  const validTests = ['wisc_v', 'wais_v_young', 'wais_v_adult', 'moca', 'daily_mood', 'stress_level', 'sleep_quality', 'work_life_balance', 'mindfulness_focus', 'social_connection', 'energy_vitality', 'emotional_intelligence', 'anxiety_screening', 'mmpi2', 'cpi_test', 'pf16_test', 'big_five', 'mmse_test', 'tmt_test', 'caps_test', 'pcl5_test', 'iesr_test', 'ymrs_test', 'bdi_test', 'mdq_test', 'hdrs_test', 'ybocs_test', 'oci_test', 'foci_test', 'mocq_test'];
...
// Public endpoint: total number of available assessments
app.get('/api/test-count', (req, res) => {
  const validTests = ['wisc_v', 'wais_v_young', 'wais_v_adult', 'moca', 'daily_mood', 'stress_level', 'sleep_quality', 'work_life_balance', 'mindfulness_focus', 'social_connection', 'energy_vitality', 'emotional_intelligence', 'anxiety_screening', 'mmpi2', 'cpi_test', 'pf16_test', 'big_five', 'mmse_test', 'tmt_test', 'caps_test', 'pcl5_test', 'iesr_test', 'ymrs_test', 'bdi_test', 'mdq_test', 'hdrs_test', 'ybocs_test', 'oci_test', 'foci_test', 'mocq_test'];
  res.json({ count: validTests.length });
});
